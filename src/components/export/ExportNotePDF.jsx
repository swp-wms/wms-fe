    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.formInfo}>
          <Text style={{ fontSize: 10 }}>Số phiếu: PX-{currentDelivery.id}</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        <View style={styles.sectionRow}>
          <Text style={styles.label}>Họ và tên người nhận hàng:</Text>
        ...
        <View style={styles.sectionRow}>
          <Text style={styles.label}>Xuất tại kho:</Text>
