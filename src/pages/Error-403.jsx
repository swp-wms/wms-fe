      ...
      <div className="flex-1">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center py-12 pt-30">
              ...
              {/* Error Message */}
              <h1  className="text-6xl font-bold text-red-600 pb-3 ">403</h1>
              <h1 className="text-3xl font-bold text-gray-900 mb-4">
                Không có quyền truy cập
              </h1>
              
              <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                Trang bạn đang tìm kiếm không thuộc thẩm quyền truy cập của bạn, xin vui lòng kiểm tra lại hoặc quay về trang chủ.
                Nếu bạn nghi ngờ đây là lỗi, vui lòng liên hệ với quản trị viên.
              </p>
